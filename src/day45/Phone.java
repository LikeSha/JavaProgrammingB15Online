...
//    static boolean useElectricity = true;
    ...
    public static void main(String[] args) {
        ...
        displayUseElectricity(); // direct call
        Electronic.displayUseElectricity(); // using static way
        Phone.displayUseElectricity(); // because subclass also have it
        // it inherited static field !
