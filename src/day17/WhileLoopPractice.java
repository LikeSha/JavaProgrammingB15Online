...
public class WhileLoopPractice {
    ...
    public static void main(String[] args) {
     ...
     // now I want to count from 5 to 1 ,using same counter
        // if I use counter>=1 as condition , I will have  -->> 6>=1 5>=1 4>=1 3>=1 2>=1 1>=1 true 0>=1 false !
        // if I use counter >1 as condition I will have this -->>6>1 5>1 4>1 3>1 2>1  true 1>=1 false !
     while(counter>1){
         --counter;
         System.out.print(counter + " ");
