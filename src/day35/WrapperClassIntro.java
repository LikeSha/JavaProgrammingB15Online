...
public class WrapperClassIntro {
    ...
    public static void main(String[] args) {
        ...
        // integer is a class type (an object),int is a primitive  ,completely different
        byte bValue = x2.byteValue(); // this is to get a byte value out of your Integer object
        System.out.println("byte Value = " + bValue);
        double dValue = x2.doubleValue();
        System.out.println("double Value = " + dValue); // this is to get a double value out of your Integer object
