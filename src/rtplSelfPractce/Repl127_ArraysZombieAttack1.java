...
public class Repl127_ArraysZombieAttack1 {
    ...
    public static void main(String[] args) {
         ...
         * and make it lose half of its population until all cities have no humans left.
        ...
        int maxPop = inhabitants[0];

        for (int i = 0; i <inhabitants.length ; i++) {
            if( maxPop < inhabitants[i]){
                maxPop = inhabitants[i];
            }
        }
