...
public class SplitPractice {
    ...
    public static void main(String[] args) {
        ...
        String[] itemSplitArr = itemDetail.split(",");
       ...
       System.out.println("item price = " + Double.parseDouble(itemDetail.split(",") [1]));
       System.out.println("item monthly = " + Double.parseDouble( itemDetail.split(",") [2]));
