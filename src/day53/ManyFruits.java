...
public class ManyFruits {
    ...
    public static void main(String[] args) {
        ...
        Fruit f1 = new Orange("sour-sweet", "redish", 11);
        ...
        // in this way ,it's not resizable \ adding removing will no work \ everything else work
        //List<Fruit> fruitList = Arrays.asList(f1,f2,3,f4);
