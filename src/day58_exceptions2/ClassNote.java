...
public class ClassNote {
     ...
     *
     *     Unchecked Exception are RuntimeException and all of its sub classes
     *
     *     Interview Questions : difference between checked and unchecked exceptions in java ?
     *
     *     CHECKED                                             UNCHECKED
     *     CHECKED EXCEPTION MUST BE                           Code will compile even if we do not handle UncheckedExceptions
     *     handled or declared for code
     *     to COMPILE
     *
     *     CHECKED Exception are Throwable,                    UncheckedExceptions are RuntimeException and all of its sub classes
     *     Exception and all its sub classes expect
     *     RuntimeException
     *
     *
     *
     ...
     * CHECKED EXCEPTIONS MUST BE HANDLED using try catch OR DECLARED for code to compile
     *
     *
     * Handling Exceptions:
     * 1) try{
