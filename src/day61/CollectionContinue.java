...
public class CollectionContinue {
    ...
    public static void main(String[] args) {
        ...
        //Collection interface as super type , pointing to and ArayyaList object
        Collection<Integer> nums = new ArrayList<>();
        nums.addAll(Arrays.asList(1,6,4,5,7,8));
        System.out.println("nums = " + nums);

        // can we use get method when we have Collection as reference type ??
        // BIG NO!!!!!!!!!!!!!!! SUPER TYPE REFEREEENCE CAN NO GET SUBCLASS ITEM. only reference type decide what WE CAN access
