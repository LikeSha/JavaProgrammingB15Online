...
public class Practice_12_18TaskJobtitle {
    ...
    public static void main(String[] args) {
      ...
      //Task 4:  //Print Initials -> Job Title for everyone
        ...
        // logic : title is in between [and] so we nned to find index of [and]
        ...
        //         get last name ( sencond word in this sentence ) and put dash in between
        ...
        Write a if statement to test if tis correct or not

         */
         if(title.equals("Electrical Engineer")){
             System.out.println("PASS: Verification successful. Philipa-Salthouse's job is Electrical Engineer");
         }else{
             System.out.println("FAIL: Verification error:  Philipa-Salthouse's job is NOT Electrical Engineer");
         }
