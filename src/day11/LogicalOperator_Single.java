...
public class LogicalOperator_Single {
    ...
    public static void main(String[] args) {
        ...
        //and eventually give you the outcome  // 99.99% we only use &&
...
//        System.out.println(  1>5 & 9>7 );
        ...
        System.out.println(     5>10 && 9/0==3   );// this wil get result " false "
        System.out.println(     5>10 & 9/0==3 );; // this will get ERROR!
