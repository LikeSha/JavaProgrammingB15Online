...
public class SplitAndDefineTheSize {
    ...
    public static void main(String[] args) {
        ...
        // split method has two versions : first split by some separator and get whatever the count of item
        // we get from the result

        // second version : accept 2 external data , one is the separator another is the limit of your array size
        // so if you have 5 words in a sentence if you split by space and put the limit for 2
