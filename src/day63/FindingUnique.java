...
public class FindingUnique {
    ...
    public static void main(String[] args) {
        ...
        String str = "The new link for joining class will require you to login to Okta, if it ask you to sign in "+
                 ", please just click on it , it will take you to Okta signin page, oce you signin with Okta" +
                " Then you will be able to join right away. PLEASE DO NOT TRY TO REGISTER, THE LINK IS ALREADY " +
                " IN THE EMAIL Click to join";
        ...
        Set<Character> charSet = new HashSet<>(); // if use LinkedHashSet ,it will print insertion order
                                                  // if use TreeSet, it will print natural order , means ascending order.
