 ...
 * *   -- add deposit method that accept 1 int argument
 * *          -- it will change the balance
 * *   -- add withdraw method that accept 1 int argument
 * *          -- reduce the balance
...
//        this.withdraw(this.balance);
    ...
    public boolean isPalindrome(){
        ...
        // first store into temp and replace all the space and make it lowercase
        //WE DO NOT WANT TO ACTUALLY CHANGE HE NAME OF THE ACCOUNT SO WE JUST WORK WITH IT'S COPY
