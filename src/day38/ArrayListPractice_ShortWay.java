...
public class ArrayListPractice_ShortWay {
    ...
    public static void main(String[] args) {
        ...
        //prices.add(12.8) ;
        //prices.remove(0);
        // Array.List.of() is in java version 8  we are using java 10  it changed to Arrays.asList
        ...
        newPrices.remove(0.99);// remove has two versions ,one is remove int ,another remove object
                                  // java will auto selected
        // remove method will remove first occurrence of the value
        System.out.println("newPrices = " + newPrices);
        // if we have two 0.99 you will always remove the first occurrence .
