...
public class MethodWithWrapperTypes {
    ...
    public static void main(String[] args) {
        ...
        // String has a class or its own so we can create object , take action with that object
        // crate variable with data type String
        ...
        sumAndPrint( new Integer (23), new Integer(10)    );// don't use this
