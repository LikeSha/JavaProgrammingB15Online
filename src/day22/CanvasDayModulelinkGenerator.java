...
public class CanvasDayModulelinkGenerator {
 ...
 //       for (int moduleNumber = 3317; moduleNumber <= 3317+(56-21) ; moduleNumber++) {
 ...
 //       }
        ...
        for (int day = 1; day <= 22 ; day++) {
            ...
            System.out.println(dayMsg + day);
            // if day is 21 the number is 3297 according to requirement
            // if day is 22 the number is 3298 according to requirement
