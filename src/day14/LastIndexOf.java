...
public class LastIndexOf {
    ...
    public static void main(String[] args) {
        ...
        // find out last location the character Ga shows up
        System.out.println("find out last location the character Ga shows up");
        System.out.println( name.lastIndexOf("Ga")    );
        // find out last location the character Kawa shows up
        System.out.println("find out last location the character Kawa shows up");
